...
modernbert_model = (
    "/home/jovyan/active-projects/itell-question-generation/results/modernbert_multirc"
)
...
def evaluate_and_score(dataset, pipes, label_key="labels"):
    ...
    metrics = {name: score(f"{name}_pred") for name in pipes}
    ...
    mpnet(
        "This a strong answer to the question",
        "This is a reference answer to the question",
    )  # Scored incorrect (0)
